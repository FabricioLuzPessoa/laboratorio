<?php
	...
	/*
	- RECEBE DE exames_pendentes.php o id do exame_pendente.
	*/
	...
	if(isset($_GET['id_exame_pendente'])) {
	
		// Transformo uma variável GET em uma variável POST.
	...
	$consulta = "SELECT id_exame_pendente, documento, data_inclusao, id_paciente, nome_paciente, id_funcionario FROM exames_pendentes WHERE id_exame_pendente='" . $_SESSION['id_exame_pendente'] . "'";

<?php
	...
	/*
	- RECEBE O ARRAY $_SESSION['valores_exames'] do script exames_pendentes_verificar;
	- � UMA COPIA DE EXAMES_CRIAR PRATICAMTENTE.
	...
	*/
	...
	$page_title = 'Insira as informações necessarias para a criacao do(s) relatorio(s)';
	...
	// Verifica se a variavel de sessão foi criada. Se a variavel de sess�o ainda n�o foi criada. nenhum código será exibido.
	if (isset($_SESSION['usuario_id'])) {

		// Faço um laço para percorrer o array vindo da pagina paciente para criar um formulário para o funcion�rio preencher os dados do exame.
		foreach ($_SESSION['valores_exames'] as $chave => $valor) {
																	
			$teste =  $chave;
?>					

<!-- ENVIA DADOS DO FORMULÁRIO  -->			
<form method="post" action = "exames_pend_ver_corre.php">
...
<table class="">
	...
	<tr>
		<td >Acido Urico:</td>
		<td><input type="text" id="acido_urico" name="acido_urico" value="<?php echo $_SESSION['valores_exames']['acido_urico'];  ?>" /></td>
	</tr>
</table>
...
<table class="">
	<legend class="h6 text-primary">informe os valores do exame Hematácrito:</legend>
	<tr>
		<td>Hematácrito (%):</td>
...
<?php
	} else if($teste == 'amostra_helmintoscopia') {
?>						
...
<?php
	} else if($teste == 'amostra_1_helmintoscopia') {
?>						
...
<?php
	} else if($teste == 'bilirrubina_direta') {
?>
<table>
	<legend class="h6 text-primary">informe o valor do exame Billirrubinas Totais e Fracoes:</legend>
	<tr>
		<td>Bilirrubina Direta: </td>
		<td><input type="text" id="bilirrubina_direta" name="bilirrubina_direta" value="<?php echo $_SESSION['valores_exames']['bilirrubina_direta']; ?>" class="form-control form-control-sm"/></td>
	</tr>
	<tr>
		<td>Bilirrubina Indireta: </td>
		<td><input type="text" id="bilirrubina_indireta" name="bilirrubina_indireta" value="<?php echo $_SESSION['valores_exames']['bilirrubina_indireta']; ?>" class="form-control form-control-sm"/></td>
	</tr>
	<tr>
		<td>Bilirrubina Total: </td>
		<td><input type="text" id="bilirrubina_total" name="bilirrubina_total" value="<?php echo $_SESSION['valores_exames']['bilirrubina_total']; ?>" class="form-control form-control-sm"/></td>
	</tr>
</table>
...
<input type="submit" id="submit" name="submit" value="Gerar Relatorio" class="btn btn-success" />
